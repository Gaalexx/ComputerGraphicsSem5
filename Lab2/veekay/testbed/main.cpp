...
namespace
{
	...
	void initialize(VkCommandBuffer cmd)
	{
		...
		{ // NOTE: Build graphics pipeline
			vertex_shader_module = loadShaderModule("/home/gaalex/MAI/5sem/CG/Lab2/veekay/shaders/shader.vert.spv");
			...
			fragment_shader_module = loadShaderModule("/home/gaalex/MAI/5sem/CG/Lab2/veekay/shaders/shader.frag.spv");
